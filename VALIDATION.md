...
- Private service: all 21 `unittest` tests passed, including actual UDP exchanges, clip/guide uploads and downloads, loss handling, duplicate results, revenge after a fresh login, trophies and reversible setup.
