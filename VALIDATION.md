...
| Strategy guide | A locally recorded Caves clip was imported into the native level directory, downloaded and played with pause, rewind and fast-forward. |
...
- Private service: all 20 `unittest` tests passed, including actual UDP exchanges, uploads/downloads, loss handling, duplicate results, revenge after a fresh login, trophies and reversible setup.
