...
from arena.games.tomb_raider.setup import configure, enable_arena, restore
...
class SetupTests(unittest.TestCase):
    def test_setup_is_idempotent_and_restore_preserves_original_files(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch('arena.games.tomb_raider.setup.enable_arena',lambda value:b'enabled launcher'):
