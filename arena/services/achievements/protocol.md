...
Hooked declares 37 achievements totalling 1000 points: IDs 1–34 are solo; 35–37 multiplayer. IDs 35 and 36 correspond to Arena login (10) and first update (20). Game UID mappings join Launcher history to that same journal. The initial six-column ledger migrates without changing earned timestamps.
