...
from arena.codec import HEADER, Object, ProtocolError, Reader, file_chunks, pages, string
from arena.server import Arena, Upload
from arena.store import Store
from arena.replay import SNAPSHOT_SIZE
...
class WireTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_native_challenge_fields_and_result_upload(self):
        from test_replay import fixture_ghost
        await self.login()
